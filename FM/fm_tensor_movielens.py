...
vec = DictVectorizer()
vec.fit_transform(df_zong.to_dict(orient='records'))
del df_zong
x_train = vec.transform(df_x_train.to_dict(orient='records')).toarray()
x_test = vec.transform(df_x_test.to_dict(orient='records')).toarray()
